...
export default function PerformanceAnalytics(){
  const { token } = useAuth()
  const [data,setData] = useState({ creators:0, links:0, clicks:0, conversions:0, revenue:0 })
  ...
  const conversionRate = data.clicks > 0 ? ((data.conversions / data.clicks) * 100).toFixed(2) : 0
  const revenuePerClick = data.clicks > 0 ? (data.revenue / data.clicks).toFixed(2) : 0
    ...
    <div className="modern-admin-container">
      ...
      <div className="modern-stats-grid">
        <div className="modern-stat-card">
          ...
          <div className="stat-content">
            ...
            <div className="stat-value">{data.creators}</div>
        ...
        <div className="modern-stat-card">
          ...
          <div className="stat-content">
            ...
            <div className="stat-value">{data.links}</div>
        ...
        <div className="modern-stat-card">
          ...
          <div className="stat-content">
            ...
            <div className="stat-value">{data.conversions}</div>
        ...
        <div className="modern-stat-card">
          ...
          <div className="stat-content">
            ...
            <div className="stat-value">${Number(data.revenue||0).toFixed(2)}</div>
      ...
      <div className="analytics-insights">
        ...
        <div className="insight-card">
          ...
          <div className="insight-value">{data.creators > 0 ? (data.links / data.creators).toFixed(1) : 0}</div>
